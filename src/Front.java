...
public class Front {
        public static void main(String[] args) throws Exception {
                ...
                try (Scanner scanner = new Scanner(System.in)) {
                        ...
                        System.out.println();
                        hostservice = "http://localhost:8082/daotest";
                        ...
                        try (Connection connect = database.getConnexion(credentials)) {
                                ...
                                for (int i = 0; i < views.length; i++) {
                                        /**** service ****/
                                        services[i] = language.generateService(entities[i], hostservice);
                                        ...
                                        /***** Route ****/
                                        routes = language.genereteChildrenRoute(entities[i], routes);
                                        importRoutes = language.genereteImportRoutes(entities[i], importRoutes);
                                        sidebar = language.genereteChildrenSidebar(entities[i], sidebar);

                                        /****** vue *****/
                                        views[i] = language.generateView(entities[i]);
