...
public class Language {
    ...
    public String generateView(Entity entity) throws IOException, Exception {
        String content = HandyManUtils.getFileContent(
    ...
    public String genereteChildrenRoute(Entity entity, String content) throws IOException {
        String newChildren = HandyManUtils.getFileContent(
    ...
    public String genereteImportRoutes(Entity entity, String content) throws IOException {
    ...
    public String genereteChildrenSidebar(Entity entity, String content) throws IOException {
        String newChildren = HandyManUtils.getFileContent(
